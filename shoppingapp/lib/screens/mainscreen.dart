...
class _MainScreenState extends State<MainScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        ...
        body: content
        //the builder will be excecuted when ever a data is produces data
        //snapshot give the access to the dtate and data that is produced
        //     FutureBuilder(
        //   future: loadeditems,
        //   //this snapshot is a list of grocery items
        ...
        //       return const Center(child: Text("Please Start Adding Groceries"));
        //     }
